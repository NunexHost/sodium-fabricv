...
public class ConfigCorruptedScreen extends Screen {
    ...
    public void render(int mouseX, int mouseY, float delta) {
        ...
        this.textRenderer.draw(Text.literal("Sodium Renderer"), 32, 32, 0xffffff);
        this.textRenderer.draw(Text.literal("Could not load the configuration file"), 32, 48, 0xff0000);
        ...
        for (int i = 0; i < TEXT_BODY.size(); i++) {
            ...
            this.textRenderer.draw(TEXT_BODY.get(i), 32, 68 + (i * 12), 0xffffff);
        }
    }
}
